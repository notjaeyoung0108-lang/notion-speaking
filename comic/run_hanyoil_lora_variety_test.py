"""Render Hanyoil LoRA blends across outfits and simple compositions."""
...
OUTPUT_ROOT = Path("comic/output/hanyoil_lora_variety_test")
...
def main() -> None:
    ...
    variants = [
        ...
        (
            "white cardigan side gaze",
            6341,
            {
                "outfit": "daily_outing_4",
        ...
        (
            "black dress close-up",
            6342,
            {
                "outfit": "daily_dressup_1",
                "action": "standing",
                "body_pose": "standing",
                "gesture": "none",
